...
- Add a markdown reference document for the package (for example, `docs/pipeline-framework.md`) that explains architecture, extension points, execution lifecycle, and authoring examples.
