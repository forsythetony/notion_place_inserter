...
- See `docs/technical-architecture/tech-debt/td-2026-03-13-retry-error-propagation-validation.md` for a planned deep validation of retry error propagation when time permits.
